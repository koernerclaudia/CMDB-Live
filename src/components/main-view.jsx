...
export const MainView = () => {
  ...
  <h4>Signup here:</h4>
   ...
   /><div><Button className="margin-top" onClick={() => { setUser(null); setToken(null); localStorage.clear(); }}>Logout</Button></div></Col>  ) : movies.length === 0 ? (
    ...
    {movies.map((movie) => (
      ...
      </><div><Button className="margin-top" onClick={() => { setUser(null); setToken(null); localStorage.clear(); }}>Logout</Button></div>
      </>
